...
public class ColorizeBlock {
    ...
    private static void reloadFoliageColors(PropertiesFile properties) {
        ...
        registerColorMap(colorMap, DEFAULT_GRASSCOLOR, "minecraft:grass:snowy=false minecraft:tallgrass:1,2:type=tall_grass,fern minecraft:double_plant:2,3:variant=double_grass,double_fern minecraft:reeds");
