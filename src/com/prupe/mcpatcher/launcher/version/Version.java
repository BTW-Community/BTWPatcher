...
public class Version {
    ...
    public static boolean fetchJson(String id, boolean forceRemote) {
        return JsonUtils.fetchURL(getJsonURL(id), getJsonPath(id), forceRemote, "{".getBytes());
    }
    ...
    public static boolean fetchJar(String id, boolean forceRemote) {
        return JsonUtils.fetchURL(getJarURL(id), getJarPath(id), forceRemote, "PK".getBytes());
    }
