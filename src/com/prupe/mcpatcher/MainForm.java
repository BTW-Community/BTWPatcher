...
class MainForm extends UserInterface {
	...
	MainForm() {
		...
		outputProfileComboBox = new JComboBox();
		origVersionComboBox = new JComboBox();
		setSelectedCheckBox = new JCheckBox();
		modTable = new JTable();
		modTableScrollPane = new JScrollPane();
		...
		classMap = new JTextArea();
		copyClassMapButton = new JButton();
		patchResults = new JTextArea();
		copyPatchResultsButton = new JButton();
		modTableScrollPane = new JScrollPane();
		optionsScrollPane = new JScrollPane();
		logScrollPane = new JScrollPane();
		classMapScrollPane = new JScrollPane();
		patchSummaryScrollPane = new JScrollPane();
		setSelectedCheckBox = new JCheckBox();
		...
		frame = new JFrame("BTWPatcher " + MCPatcher.DISPLAY_VERSION_STRING);
